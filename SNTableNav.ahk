...
GetTableName(windownumpad){
	if (windownumpad = 1){
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName1
	} else if (windownumpad = 2){
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName2
	} else if (windownumpad = 3){
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName3
	} else if (windownumpad = 4){
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName4
	} else if (windownumpad = 5){
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName5
	} else if (windownumpad = 6) {
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName6
	} else if (windownumpad = 7) {
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName7
	} else if (windownumpad = 8) {
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName8
	} else if (windownumpad = 9) {
		IniRead, TableName, %A_ScriptFullPath%, TableNames, TableName9
	}
	return TableName
}
